...
const models = [
  ...
  { id: 'gemini-2.5-flash-lite', label: 'Gemini 2.5 Flash Lite', badge: 'Light', color: 'text-purple-400', bg: 'bg-purple-400', desc: 'Ultra-lightweight & fast', emoji: '⚡' },
  { id: 'gemini-2.0-flash', label: 'Gemini 2.0 Flash', badge: '', color: 'text-cyan-400', bg: 'bg-cyan-400', desc: 'Fast & capable', emoji: '🚀' },
  { id: 'gemini-2.0-flash-lite', label: 'Gemini 2.0 Flash Lite', badge: 'Lite', color: 'text-purple-300', bg: 'bg-purple-300', desc: 'Ultra-lightweight', emoji: '💨' },
]
